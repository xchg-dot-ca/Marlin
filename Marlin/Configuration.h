 ...
 */
/* Modified for RIGIDBOT */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 44.3090, 22.1545, 1600, 56.2 }
...
#if ENABLED(BLTOUCH)
  // On Original RBB board soldered wire directly to pin 1 of Mega2650
  #define SERVO0_PIN 4 // Mega2650 physical pin 1, digial pin 4, (OC0B)PG5
